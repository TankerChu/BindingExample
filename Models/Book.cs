...
namespace BindingExample.Models
{
    public class Book
    {
    ...
    public class BookManager
    {
        public static List<Book> GetBooks()
        {
            ...
            books.Add(new Book { BookID = 2, Title = "Malzim", Author = "Sequiter Que", CoverImage = "Assets/2.png" });
            ...
            books.Add(new Book { BookID = 5, Title = "Fulgait Eros Libex", Author = "Accusam", CoverImage = "Assets/5.png" });
